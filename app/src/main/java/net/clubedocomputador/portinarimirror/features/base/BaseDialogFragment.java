package net.clubedocomputador.portinarimirror.features.base;
...
import net.clubedocomputador.portinarimirror.PortinariMirrorApplication;
import net.clubedocomputador.portinarimirror.util.AppLogger;
import net.clubedocomputador.portinarimirror.util.Util;
import butterknife.ButterKnife;
import net.clubedocomputador.portinarimirror.injection.component.ConfigPersistentComponent;
import net.clubedocomputador.portinarimirror.injection.component.DaggerConfigPersistentComponent;
...
public abstract class BaseDialogFragment extends DialogFragment {
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(PortinariMirrorApplication.get(getActivity()).getComponent())
                            .build();
    ...
    public void showError(Throwable error) {
        Util.DialogFactory.createGenericErrorDialog(getContext(), error).show();
